 ...
 * @returns хэш
 */
exports.createHash = _afterPluginsLoaded_1._afterPluginsLoaded(function (unencryptedMessage, algorithm) {
    if (algorithm === void 0) { algorithm = 'GOST_3411_2012_512'; }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.createObject = exports.CreateObjectAsync = exports.CreateObject = void 0;
var _afterPluginsLoaded_1 = __webpack_require__(/*! ../helpers/_afterPluginsLoaded */ "./helpers/_afterPluginsLoaded.ts");
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
/**
 ...
 * @returns {Promise} .
 */
exports.CreateObjectAsync = _afterPluginsLoaded_1._afterPluginsLoaded(function (cls) { return window.cadesplugin.CreateObjectAsync(cls); });
/**
...
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
var createObject_1 = __webpack_require__(/*! ./createObject */ "./api/createObject.ts");
 ...
 */
exports.getCertificates = _afterPluginsLoaded_1._afterPluginsLoaded(function (resetCache, storeParams) {
    if (resetCache === void 0) { resetCache = false; }
    if (storeParams === void 0) { storeParams = [
        constants_1.CAPICOM_CURRENT_USER_STORE,
        constants_1.CAPICOM_MY_STORE,
        constants_1.CAPICOM_STORE_OPEN_MAXIMUM_ALLOWED,
    ]; }
    return window.cadesplugin.async_spawn(function () {
        var cadesStore, error_1, cadesCertificates, cadesCertificatesCount, error_2, certificateList, cadesCertificate, _a, _b, _c, _d, _e, error_3;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    try {
                        cadesStore = createObject_1.createObject('CAdESCOM.Store');
                    }
                    catch (error) {
                        console.error(error);
                ...
                case 1:
                    _f.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, cadesStore.Open.apply(cadesStore, storeParams)];
                case 2:
                    _f.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _f.sent();
                    console.error(error_1);
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error_1) || 'Ошибка при открытии хранилища');
                case 4:
                    _f.trys.push([4, 10, , 11]);
                    return [4 /*yield*/, cadesStore.Certificates];
                case 5:
                    cadesCertificates = _f.sent();
                    if (!cadesCertificates) return [3 /*break*/, 9];
                    return [4 /*yield*/, cadesCertificates.Find(constants_1.CAPICOM_CERTIFICATE_FIND_TIME_VALID)];
                case 6:
                    cadesCertificates = _f.sent();
                    return [4 /*yield*/, cadesCertificates.Find(constants_1.CAPICOM_CERTIFICATE_FIND_EXTENDED_PROPERTY, constants_1.CAPICOM_PROPID_KEY_PROV_INFO)];
                case 7:
                    /**
                     ...
                     */
                    cadesCertificates = _f.sent();
                    return [4 /*yield*/, cadesCertificates.Count];
                case 8:
                    cadesCertificatesCount = _f.sent();
                    _f.label = 9;
                case 9: return [3 /*break*/, 11];
                case 10:
                    error_2 = _f.sent();
                    console.error(error_2);
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error_2) || 'Ошибка получения списка сертификатов');
                case 11:
                    ...
                    _f.label = 12;
                case 12:
                    _f.trys.push([12, 22, , 23]);
                    _f.label = 13;
                case 13:
                    if (!cadesCertificatesCount) return [3 /*break*/, 21];
                    return [4 /*yield*/, cadesCertificates.Item(cadesCertificatesCount)];
                case 14:
                    cadesCertificate = _f.sent();
                    _b = (_a = certificateList).push;
                    _c = certificate_1.Certificate.bind;
                    _d = [void 0, cadesCertificate];
                    _e = _extractCommonName_1._extractCommonName;
                    return [4 /*yield*/, cadesCertificate.SubjectName];
                case 15:
                    _d = _d.concat([_e.apply(void 0, [_f.sent()])]);
                    return [4 /*yield*/, cadesCertificate.IssuerName];
                case 16:
                    _d = _d.concat([_f.sent()]);
                    return [4 /*yield*/, cadesCertificate.SubjectName];
                case 17:
                    _d = _d.concat([_f.sent()]);
                    return [4 /*yield*/, cadesCertificate.Thumbprint];
                case 18:
                    _d = _d.concat([_f.sent()]);
                    return [4 /*yield*/, cadesCertificate.ValidFromDate];
                case 19:
                    _d = _d.concat([_f.sent()]);
                    return [4 /*yield*/, cadesCertificate.ValidToDate];
                case 20:
                    _b.apply(_a, [new (_c.apply(certificate_1.Certificate, _d.concat([_f.sent()])))()]);
                ...
                case 22:
                    ...
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error_3) || 'Ошибка обработки сертификатов');
                case 23:
                    cadesStore.Close();
 ...
 */
exports.getSystemInfo = function (aboutCSP_CryptoPro) {
    if (aboutCSP_CryptoPro === void 0) { aboutCSP_CryptoPro = true; }
    var sysInfo = {
        cadesVersion: null,
        cspVersion: null,
    };
    return window.cadesplugin.async_spawn(function () {
        var cadesAbout, _a, PROVIDER_NAME, PROVIDER_TYPE, _b, _c, _d, _e, _f, error_1;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _g.trys.push([0, 11, , 12]);
                    return [4 /*yield*/, createObject_1.createObject('CAdESCOM.About')];
                case 1:
                    cadesAbout = _g.sent();
                    _a = sysInfo;
                    return [4 /*yield*/, cadesAbout.PluginVersion];
                case 2:
                    _a.cadesVersion = _g.sent();
                    if (!aboutCSP_CryptoPro) return [3 /*break*/, 4];
                    PROVIDER_NAME = 'Crypto-Pro GOST R 34.10-2001 Cryptographic Service Provider';
                    PROVIDER_TYPE = 75;
                    _b = sysInfo;
                    return [4 /*yield*/, cadesAbout.CSPVersion(PROVIDER_NAME, PROVIDER_TYPE)];
                case 3:
                    _b.cspVersion = _g.sent();
                    return [3 /*break*/, 6];
                case 4:
                    _c = sysInfo;
                    return [4 /*yield*/, cadesAbout.CSPVersion()];
                case 5:
                    _c.cspVersion = _g.sent();
                    _g.label = 6;
                case 6:
                    if (!!sysInfo.cadesVersion) return [3 /*break*/, 8];
                    _d = sysInfo;
                    return [4 /*yield*/, cadesAbout.Version];
                case 7:
                    _d.cadesVersion = _g.sent();
                    _g.label = 8;
                case 8:
                    _e = sysInfo;
                    return [4 /*yield*/, sysInfo.cadesVersion.toString()];
                case 9:
                    _e.cadesVersion = _g.sent();
                    _f = sysInfo;
                    return [4 /*yield*/, sysInfo.cspVersion.toString()];
                case 10:
                    _f.cspVersion = _g.sent();
                    return [3 /*break*/, 12];
                case 11:
                    error_1 = _g.sent();
                    console.error(error_1);
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error_1) || 'Ошибка при получении информации о системе');
                case 12: return [2 /*return*/, sysInfo];
            }
        });
    });
};
...
__exportStar(__webpack_require__(/*! ./createSignature */ "./api/createSignature.ts"), exports);
...
__exportStar(__webpack_require__(/*! ./createObject */ "./api/createObject.ts"), exports);
...
__exportStar(__webpack_require__(/*! ./constants */ "./constants/index.ts"), exports);
