 ...
 * @returns {Promise} .
 */
exports.CreateObjectAsync = _afterPluginsLoaded_1._afterPluginsLoaded((cls) => window.cadesplugin.CreateObjectAsync(cls));
/**
 ...
 */
exports.createObject = _afterPluginsLoaded_1._afterPluginsLoaded((cls) => __awaiter(void 0, void 0, void 0, function* () {
    let result;
    try {
        result = yield window.cadesplugin.CreateObjectAsync(cls);
    }
    catch (error) {
        console.error(error);
        throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при попытке доступа к ' + cls);
    }
    return result;
}));
...
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
const createObject_1 = __webpack_require__(/*! ./createObject */ "./api/createObject.ts");
 ...
 */
exports.getCertificates = _afterPluginsLoaded_1._afterPluginsLoaded((resetCache = false, storeParams = [
    ...
    try {
        ...
        if (cadesCertificates) {
            cadesCertificates = yield cadesCertificates.Find(constants_1.CAPICOM_CERTIFICATE_FIND_TIME_VALID);
            /**
             * Не рассматриваются сертификаты, в которых отсутствует закрытый ключ
             * или не действительны на данный момент
             */
            cadesCertificates = yield cadesCertificates.Find(constants_1.CAPICOM_CERTIFICATE_FIND_EXTENDED_PROPERTY, constants_1.CAPICOM_PROPID_KEY_PROV_INFO);
    ...
    try {
        while (cadesCertificatesCount) {
            ...
            certificateList.push(new certificate_1.Certificate(cadesCertificate, _extractCommonName_1._extractCommonName(yield cadesCertificate.SubjectName), yield cadesCertificate.IssuerName, yield cadesCertificate.SubjectName, yield cadesCertificate.Thumbprint, yield cadesCertificate.ValidFromDate, yield cadesCertificate.ValidToDate));
 ...
 */
exports.getSystemInfo = (aboutCSP_CryptoPro = true) => {
    const sysInfo = {
        cadesVersion: null,
        cspVersion: null,
    };
    return window.cadesplugin.async_spawn(function* () {
        let cadesAbout;
        try {
            cadesAbout = yield createObject_1.createObject('CAdESCOM.About');
